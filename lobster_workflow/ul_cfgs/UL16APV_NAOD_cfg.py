...
# with command line options: Configuration/GenProduction/python/ttgamma_custom_ND-fragment.py --python_filename UL16APV_NAOD_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --filein file:MAOD-00000.root --fileout file:NAOD-00000.root --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --geometry DB:Extended --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --no_exec --mc -n -1
