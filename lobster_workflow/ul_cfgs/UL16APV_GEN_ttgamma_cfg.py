...
# with command line options: Configuration/GenProduction/python/ttgammaJets_custom_ND-fragment.py --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step GEN --geometry DB:Extended --era Run2_2016 --fileout file:GEN-00000.root --filein file:LHE-00000.root --python_filename UL16_GEN_ttgammaJet_cfg.py --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('/afs/crc.nd.edu/user/b/byates2/mgprod/lobster_workflow/fragments/ttgamma_custom_ND-fragment.py nevts:1'),
