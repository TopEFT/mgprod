...
# with command line options: fragments/ttgamma_custom_ND-fragment.py --mc --python_filename testNanoGenCfg_UL16APV.py --eventcontent NANOAODGEN --datatier NANOAOD --filein file:GEN-00000.root --fileout file:NAOD-00000.root --conditions 106X_mcRun2_asymptotic_preVFP_v11 --beamspot Realistic25ns13TeVEarly2016Collision --step NANOGEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('fragments/ttgamma_custom_ND-fragment.py nevts:1'),
