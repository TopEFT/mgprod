...
# with command line options: step1   --mc   --eventcontent NANOAODSIM --datatier NANOAODSIM   --python_filename UL18_NAOD_cfg.py   --conditions 106X_upgrade2018_realistic_v16_L1v1   --filein file:MAOD-00000.root --fileout file:NAOD-00000.root   --step NANO --era Run2_2018,run2_nanoAOD_106Xv2 -n -1 --no_exec
