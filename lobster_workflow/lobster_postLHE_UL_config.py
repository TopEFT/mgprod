...
master_label = 'EFT_GLADOSandCRC_postLHE_{tstamp}'.format(tstamp=timestamp_tag)
...
PATH_TO_NAOD_CMSSW = "/afs/crc.nd.edu/user/a/apiccine/Lobster-With-Conda/mgprod/lobster_workflow/CMSSW_10_6_26" #CMSSW_10_6_26"
...
# Name the output
out_ver = "v1_GCRC"   # The version index for the OUTPUT directory
...
input_dirs = [
    ...
    #os.path.join(input_path_full,"byates/ttgamma/LHE/2016/crab_ttgamma_LHE/240522_161408/"),
    os.path.join(input_path_full,"apiccine/FullProduction/FullR2/UL16/Round1/Batch1/postLHE_step/v1_GCRC"), ##for minis
...
config = Config(
    ...
    advanced=AdvancedOptions(
        ...
        threshold_for_failure=75,
        threshold_for_skipping=75,
    )
)
