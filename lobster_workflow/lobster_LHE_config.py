...
abs_path = '/afs/crc.nd.edu/user/a/apiccine/Lobster-With-Conda/mgprod/lobster_workflow/'
...
master_label = 'EFT_test_{tstamp}'.format(tstamp=timestamp_tag)
...
gridpack_list = [
    ...
    #'byates2/ttgamma_dilep_ttgamma_ptj10_restrict_run0_slc7_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz', ###with restrict card
...
for idx,gridpack in enumerate(gridpack_list):
    ...
    lhe = Workflow(
        ...
        sandbox=cmssw.Sandbox(release=abs_path+rel),
